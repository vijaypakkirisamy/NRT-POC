...
//      .setAppName("LimitBreachtags")
//      .set(ConfigurationOptions.ES_NODES, "c4b88b17a3194a64b9e04a70b8613e5b.us-central1.gcp.cloud.es.io")
...
//      .set(ConfigurationOptions.ES_NET_HTTP_AUTH_PASS, "Fiw8g63BzNEOeaWYj8ESNY5d")
    ...
    val conf = new SparkConf().setAppName("LimitsBreach")
                              //.setMaster("local[*]")
                              .set("es.index.auto.create", "true")
                              .set("es.nodes","c4b88b17a3194a64b9e04a70b8613e5b.us-central1.gcp.cloud.es.io")
                              .set("es.port", "443")
   ...
   val dstream = ssc.queueStream(microbatches)
    EsSparkStreaming.saveToEs(dstream, "limitbreaches/transacdtls")
